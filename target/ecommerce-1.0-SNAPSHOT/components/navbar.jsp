            ...
            <ul class="navbar-nav ml-auto">
                <li class="nav-item active">
                    <a class="nav-link" href="#!" data-toggle="modal" data-target="#cart">
                        <i class="fas fa-shopping-cart" style="font-size: 20px"><span id="cartCount" class="cart-items">(0)</span></i></a>
                </li>
                <%
                    if (user1 == null) {
                %>
                ...
                %>
                <li class="nav-item active">
                    <a class="nav-link" href="/ecommerce/admin.jsp"><%= user1.getUserName()%></a>
                </li>
                <%
                } else {
                %>
                ...
                %>
                <li class="nav-item active">
                    <a class="nav-link" href="/ecommerce/Logout">Logout</a>
                </li>
                <%
                    }
                %>
