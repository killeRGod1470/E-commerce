...
//                creating user object to save data
                User user=new User(userName, userEmail, userPassword, userMobile, "default.jpg", userAddress,"normal");
                ...
                httpSession.setAttribute("message", "Registration successfull !!!<br> The user id is "+userId);
